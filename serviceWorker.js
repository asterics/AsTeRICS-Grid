...
self.addEventListener('activate', event => {
    ...
    console.log('Service Worker active! Version: https://github.com/asterics/AsTeRICS-Grid/releases/tag/release-latest-2025-01-23-11.55/+0100');
});
