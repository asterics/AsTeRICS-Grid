...
if (self.URLS_TO_CACHE && self.URLS_TO_CACHE.length > 0) {
    ...
    const precacheManifest = self.URLS_TO_CACHE.map(url => ({
        url: url,
        revision: 'release-latest-2026-02-26-09.35/+0100'
    }));
...
self.addEventListener('activate', event => {
    event.waitUntil((async () => {
        ...
        console.log('Service Worker active! Version: https://github.com/asterics/AsTeRICS-Grid/releases/tag/release-latest-2026-02-26-09.35/+0100');
    })());
});
