<template>
    <div ref="container" class="grid-item-content" style="background-color: rgb(198,236,253);">
        ...
        <grid-element-text-container :with-image="!!imageData" :metadata="metadata" :watch-id="watchId" :disable-auto-size-keyboard="true" :grid-element="gridElement" v-bind="$attrs"/>
    </div>
</template>
...
export default {
    ...
    props: ["gridElement", "metadata", "watchId"],
    data() {
        return {
