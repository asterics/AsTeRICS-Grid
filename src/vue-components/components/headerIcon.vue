<template>
    <component :is="tag" v-if="!fullHeader || show">
        <div>
            ...
            <a tabindex="22" aria-hidden="true" href="#main" class="show-mobile"><h1 class="inline"><img id="astericsIcon" src="app/img/asterics-aac-logo-raw-small.svg" alt="Asterics AAC" style="margin: 0"/></h1></a>
        </div>
    </component>
</template>
