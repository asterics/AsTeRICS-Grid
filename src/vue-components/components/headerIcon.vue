    ...
    <component :is="tag" v-if="!fullHeader || show">
        <div>
            <div v-if="show">
                ...
                <a tabindex="21" aria-hidden="true" href="#main" class="hide-mobile"><h1 class="inline"><img id="astericsIcon" src="app/img/asterics-grid-icon-raw.svg" height="40" width="121" alt="Asterics AAC"/></h1></a>
            </div>
            <a tabindex="22" aria-hidden="true" href="#main" class="show-mobile"><h1 class="inline"><img id="astericsIcon" src="app/img/asterics_icon.png" alt="Asterics AAC" style="margin: 0"/></h1></a>
        </div>
    </component>
</template>
