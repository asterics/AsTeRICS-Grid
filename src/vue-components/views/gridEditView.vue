...
function initContextmenu() {
    ...
    var itemsMoreMenuButton = {
        ...
        CONTEXT_GRID_NAVIGATION: {
            name: i18nService.t('navigateToOtherGrid'),
            icon: 'fas fa-arrow-right',
            visible: visibleFn
        },
        CONTEXT_MOVE_TO: {
            name: i18nService.t('moveElementToOtherGrid'),
        ...
        CONTEXT_FILL_EMPTY: {
            name: i18nService.t('fillWithEmptyElements'),
            icon: 'fas fa-fill',
            visible: visibleFnFill
        },
        ...
        CONTEXT_EDIT_GLOBAL_GRID: {
            name: i18nService.t('editGlobalGrid'),
            icon: 'fas fa-globe',
            visible:
                !!vueApp.metadata.globalGridId &&
                vueApp.metadata.globalGridActive &&
                vueApp.metadata.globalGridId !== vueApp.gridData.id
        },
        CONTEXT_END_EDIT_GLOBAL_GRID: {
            name: i18nService.t('endEditGlobalGrid'),
            icon: 'fas fa-globe',
            visible: vueApp.metadata.globalGridId === vueApp.gridData.id
        },
        SEP2: '---------',
