      ...
      <div class="row">
        ...
        <div class="col-9 col-md-4">
          <input class="col-12" id="searchItems" v-model="searchText" @input="setFirstItem()"
                 :placeholder="$t('placeholder-searchItem')" spellcheck="false" autocomplete="false" type="text">
        </div>
        <div class="col-3">
          <button class="py-0 px-3 mb-0" @click="searchText = ''; setFirstItem();" :title="$t('DeleteSearchText')"><i
