<template>
    <div class="mt-0">
        <div class="srow mt-0">
            <slider-input label="Minimum pause for collecting and speaking the same cell several times in a row" id="minPauseSeCollectSpeak" min="0" max="10000" step="200" unit="s" decimals="1" display-factor="0.001" v-model.number="inputConfig.globalMinPauseCollectSpeak" @change="changed"/>
        </div>
