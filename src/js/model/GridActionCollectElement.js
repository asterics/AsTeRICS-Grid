...
class GridActionCollectElement extends Model({
    ...
    static getActions() {
        return [
            ...
            GridActionCollectElement.COLLECT_ACTION_SEND_TO_PARTNER,
            GridActionCollectElement.COLLECT_ACTION_TOGGLE_AUTO_SEND,
...
GridActionCollectElement.COLLECT_ACTION_SHARE = 'COLLECT_ACTION_SHARE';
GridActionCollectElement.COLLECT_ACTION_SEND_TO_PARTNER = 'COLLECT_ACTION_SEND_TO_PARTNER';
GridActionCollectElement.COLLECT_ACTION_TOGGLE_AUTO_SEND = 'COLLECT_ACTION_TOGGLE_AUTO_SEND';
GridActionCollectElement.COLLECT_ACTION_COPY_IMAGE_CLIPBOARD = 'COLLECT_ACTION_COPY_IMAGE_CLIPBOARD';
