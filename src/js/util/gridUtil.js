...
gridUtil.generateGlobalGrid = function (homeGridId, locale) {
    ...
    let elementHome = new GridElement({
        ...
        x: 0,
        y: 0,
        label: i18nService.getTranslationObject(i18nService.t('homeStart'), locale),
        image: new GridImage({
    ...
    let elementBack = new GridElement({
        ...
        x: 1,
        y: 0,
        label: i18nService.getTranslationObject(i18nService.t('back'), locale),
        image: new GridImage({
    ...
    let elementBackspace = new GridElement({
        label: i18nService.getTranslationObject(i18nService.t('deleteWord'), locale),
        width: 1,
        height: 1,
    ...
    let elementClear = new GridElement({
        label: i18nService.getTranslationObject(i18nService.t('clear'), locale),
        width: 1,
        height: 1,
