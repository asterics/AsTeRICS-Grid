...
i18nService.translations['en'] = {
    ...
    CONFIRM_IMPORT_BACKUP: 'Caution: This will delete all existing data and replace them with the data from the backup "{?}". Continue?',
...
i18nService.translations['de'] = {
    ...
    CONFIRM_IMPORT_BACKUP: 'Achtung: Diese Aktion wird alle existierenden Daten löschen und sie mit den Daten des Backups "{?}" ersetzen. Fortfahren?',
