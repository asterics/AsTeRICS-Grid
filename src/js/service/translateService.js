...
translateService.translations['en'] = {
    ...
    VALIDATION_ERROR_REGEX: "Username must start lowercase and may only contain lowercase [a-z], numbers [0-9] and '+', '-' or '_'.",
...
translateService.translations['de'] = {
    ...
    VALIDATION_ERROR_REGEX: "Username muss mit einem Kleinbuchstaben beginnen und darf nur Kleinbuchstaben [a-z], Zahlen [0-9] und '+', '-' oder '_' enthalten.",
