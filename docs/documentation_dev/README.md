...
The following docs do not include interface documentation about Javascript modules and their public methods. Most important code docs can be found in [JSDoc](https://github.com/jsdoc/jsdoc) format in the [Asterics AAC sources](https://github.com/asterics/AsTeRICS-Grid/tree/master/src/js).
