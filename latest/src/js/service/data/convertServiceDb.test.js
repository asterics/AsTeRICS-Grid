...
test('convertServiceDb.convertLiveToDatabaseObjects - Test 1', () => {
    let object = {};
    let exptectedResult = {
        encrypted: true
    };
    expect(convertServiceDb.convertLiveToDatabaseObjects(object)).toEqual(exptectedResult);
});

test('convertServiceDb.convertLiveToDatabaseObjects - Test 2', () => {
    let objects = [{anything: true}, {anything2: true}];
    let props = {
        encrypted: true
    };
    let expectedResult = [Object.assign({}, props, objects[0]), Object.assign({}, props, objects[1])];
    expect(convertServiceDb.convertLiveToDatabaseObjects(objects)).toEqual(expectedResult);
});

test('convertServiceDb.convertLiveToDatabaseObjects - Test 3', () => {
    let objects = null;
    expect(convertServiceDb.convertLiveToDatabaseObjects(objects)).toEqual(null);
});

test('convertServiceDb.convertDatabaseToLiveObjects - Test 1', () => {
    //objects have no modelVersion, so the should not be decrypted
    let object = {};
    let exptectedResult = {};
    expect(convertServiceDb.convertDatabaseToLiveObjects(object)).toEqual(exptectedResult);
});

test('convertServiceDb.convertDatabaseToLiveObjects - Test 2', () => {
    //objects have no modelVersion, so the should not be decrypted
    let objects = [{anything: true}, {anything2: true}];
    let props = {};
    let expectedResult = [Object.assign({}, props, objects[0]), Object.assign({}, props, objects[1])];
    expect(convertServiceDb.convertDatabaseToLiveObjects(objects)).toEqual(expectedResult);
});

test('convertServiceDb.convertDatabaseToLiveObjects - Test 3', () => {
...
test('convertServiceDb.convertDatabaseToLiveObjects - Test 4', () => {
...
test('convertServiceDb.convertDatabaseToLiveObjects - Test 5', () => {
    let objects = null;
    expect(convertServiceDb.convertDatabaseToLiveObjects(objects)).toEqual(null);
});


test('convertServiceDb.convertDatabaseToLiveObjects - any major v1 to v2', () => {
...
test('convertServiceDb.convertDatabaseToLiveObjects - metadata major v1 to v2', () => {
    ...
    let spy = jest.spyOn(modelUtil, 'getModelVersionString').mockImplementation(() => modelVersionStringV2);
    let result = convertServiceDb.convertDatabaseToLiveObjects(objects);
...
test('convertServiceDb.updateDatamodel - metadata major v2 to v3', () => {
    ...
    jest.spyOn(i18nService, 'getCurrentLang').mockImplementation(() => 'de');
    let result = convertServiceDb.updateDataModel(gridDataV2);
...
test('convertServiceDb.updateDatamodel - keep array or single object', () => {
    let gridDataV2 = {id: "test"};
    let result1 = convertServiceDb.updateDataModel(gridDataV2);
    let result2 = convertServiceDb.updateDataModel([gridDataV2]);
