...
rsync -LKIr --update backup-reader@1ce28d.online-server.cloud:/opt/couchdb/data $1/$foldername
rsync -LKIr --update backup-reader@1ce28d.online-server.cloud:/opt/couchdb/etc $1/$foldername
