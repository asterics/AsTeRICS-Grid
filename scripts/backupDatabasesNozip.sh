...
rsync -LKIrv --update root@1ce28d.online-server.cloud:/opt/couchdb/data $1/$foldername &> $log_file
rsync -LKIrv --update root@1ce28d.online-server.cloud:/opt/couchdb/etc $1/$foldername &>> $log_file
