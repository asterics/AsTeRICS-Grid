...
scp -r -l 20000 backup-reader@1ce28d.online-server.cloud:/opt/couchdb/data $1/$foldername &> $log_file
#rsync -LKIrv --update backup-reader@1ce28d.online-server.cloud:/opt/couchdb/data $1/$foldername &> $log_file

scp -r -l 20000 backup-reader@1ce28d.online-server.cloud:/opt/couchdb/etc $1/$foldername &>> $log_file
